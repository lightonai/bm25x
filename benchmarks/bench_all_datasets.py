"""Benchmark bm25x across all BEIR datasets: index d/s, search q/s, NDCG@10."""
...
def bench_bm25x(corpus_ids, corpus_texts, test_queries, ir_qrels):
    # Index
...
for name, path in DATASETS.items():
    ...
    res = bench_bm25x(corpus_ids, corpus_texts, test_queries, ir_qrels)
    print(
